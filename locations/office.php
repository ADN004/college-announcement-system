...
/* Allow only office location */
if (!isset($_SESSION['location']) || $_SESSION['location'] !== 'office') {
...
/* Fetch approved & playable Office announcements */
$sql = "
...
function playNext() {
    ...
    player.onended = () => {
        fetch("played.php?id=" + a.id + "&location=Office");
        index++;
        playNext();
    };
}
